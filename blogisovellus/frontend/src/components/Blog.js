  ...
  return (
    <div>
      <Panel bsStyle="info">
        ...
        <Panel.Body>
          <div style={hide}>
            <Button bsStyle="info" onClick={likeBlog(blog.id)}>
              <Glyphicon glyph="thumbs-up" /> Tykkää blogista
            </Button>
          </div>
          <div style={hide2}>
            <Link to="/blogs">
              <Button bsStyle="primary" onClick={removeBlog(blog.id)}>
                <Glyphicon glyph="trash" /> Poista blogi
              </Button>
            </Link>
            <Link to={`/updateblog/${blog.id}`}>
              <Button bsStyle="info">
                <Glyphicon glyph="edit" /> Muokkaa blogia
              </Button>
            </Link>
          </div>
          <div>
                  ...
                  <FormGroup controlId="formControlsTextarea">
                    <div>
                      <FormControl
                        ...
                        placeholder="Kirjoita oma kommenttisi"
                        value={contentValue}
                        onChange={handleContentChange}
                      />
                    </div>
                    <Button bsStyle="info" type="submit">
                      <Glyphicon glyph="pencil" /> Kommentoi
                    </Button>
                  </FormGroup>
                </form>
              </Panel>
